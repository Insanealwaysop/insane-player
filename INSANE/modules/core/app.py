...
class App(Client):
    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                await self.one.send_message(
                    config.LOG_GROUP_ID,
                    f"**━━━━━━━━━━━━━━━━━━━**\n**✅ 𝐀𝐬𝐬𝐢𝐬𝐭𝐚𝐧𝐭 𝟏 𝐇𝐚𝐬 𝐒𝐭𝐚𝐫𝐭𝐞𝐝 🥳**\n**━━━━━━━━━━━━━━━━━━━**\n**🥀 𝐍𝐚𝐦𝐞 ›** {self.one.name}\n**🌸 𝐋𝐢𝐧𝐤 : ›** @{self.one.username}\n**🌷 𝐈𝐃✩ : ›** `{self.one.id}`\n**━━━━━━━━━━━━━━━━━━━**\n**🔥 𝐏𝐨𝐰𝐞𝐫𝐞𝐝 𝐁𝐲 : [𝐈𝐧𝐬𝐚𝐧𝐞 𝐒𝐞𝐫𝐯𝐞𝐫](https://t.me/SAREEFO_KI_DUNIYA).**\n**━━━━━━━━━━━━━━━━━━━**",
        ...
        if config.STRING2:
            ...
            try:
                await self.two.join_chat("thextzinSANEOP")
                await self.two.join_chat("sraeefo_ki_duniyA")
                await self.two.join_chat("about_INSANEop")
            except:
                pass
            assistants.append(2)
            try:
        ...
        if config.STRING3:
            ...
            try:
                await self.three.join_chat("thextzinsaneop")
                await self.three.join_chat("sareefo_ki_duniya")
                await self.three.join_chat("about_insaneop")
            except:
                pass
            assistants.append(3)
            try:
        ...
        if config.STRING4:
            ...
            try:
                await self.four.join_chat("thextzinsaneop")
                await self.four.join_chat("sareefo_ki_duniyA")
                await self.four.join_chat("about_insaneop")
            except:
                pass
            assistants.append(4)
            try:
                await self.four.send_message(
                  ...
                  [𝐈𝐧𝐬𝐚𝐧𝐞 𝐒𝐞𝐫𝐯𝐞𝐫](https://t.me/sareefo_ki_duniya).**\n**━━━━━━━━━━━━━━━━━━━**",
                  disable_web_page_preview=True
                )
            except:
                LOGGER(__name__).error(
        ...
        if config.STRING5:
            ...
            try:
                await self.five.join_chat("thextzinsaneop")
                await self.five.join_chat("sareefo_ki_duniyA")
                await self.five.join_chat("about_insaneop")
            except:
                pass
            assistants.append(5)
            try:
